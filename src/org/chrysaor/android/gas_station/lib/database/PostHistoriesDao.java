...
public class PostHistoriesDao {
    ...
    private static final String[] COLUMNS = { COLUMN_ID, COLUMN_SHOP_ID,
            COLUMN_KAKUNIN, COLUMN_KUBUN, COLUMN_NEDAN0, COLUMN_NEDAN1,
            COLUMN_NEDAN2, COLUMN_NEDAN3, COLUMN_NEDAN3, COLUMN_REGDATEGAP,
            COLUMN_REGDATETIME, COLUMN_MEMO, COLUMN_GENTEI, COLUMN_DATE };
